...
import kr.centero.netzero.common.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    private static final String NETZERO_API_ENTRY_POINTS = "/api/netzero/v1/**";
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        ...
        http.authorizeHttpRequests(auth ->
                auth
                        .requestMatchers(new MvcRequestMatcher(introspector, NETZERO_API_ENTRY_POINTS))
                        .hasAnyRole(ERole.NETZERO_USER.name(), ERole.NETZERO_ADMIN.name())
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://netzero.centero.kr:3000", "http://common-api.centero.kr:8080", "http://netzero-api.centero.co.kr:8082" ));
