...
/**
 * NetZero Server-JwtAuthenticationFilter:
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (!isValidAccessToken) {
                ...
                log.info("3.isValidRefreshToken==========>{}", accessToken);
                ...
                log.info("4.isValidRefreshToken===================>{}", isValidRefreshToken);
    ...
    private void refreshToken(String accessToken, String refreshToken, String username, List<String> roles, HttpServletRequest request, HttpServletResponse response) {
        ...
        String newAccessToken = objectMapper.convertValue(apiResponse.getData(), String.class);
        log.info("5.[NETZERO::New Access Token=======>{}", newAccessToken);
