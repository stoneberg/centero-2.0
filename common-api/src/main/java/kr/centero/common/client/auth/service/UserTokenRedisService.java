...
public class UserTokenRedisService {
     ...
     */
    public void save(RedisTokenEntity userTokenEntity) {
     ...
     * @param userTokenEntity user token entity
     */
    public void update(String accessToken, RedisTokenEntity userTokenEntity) {
     ...
     */
    public RedisTokenEntity findByAccessToken(String accessToken) {
     ...
     * @return user token entity
     */
    public RedisTokenEntity findByUsername(String username) {
