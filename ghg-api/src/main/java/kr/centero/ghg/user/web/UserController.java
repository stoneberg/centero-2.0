...
public class UserController {
    ...
    // A.사용자 상세 조건 조회 (request param: username, email, role) : Mapping Query String
    // Parameters to ModelAttributes
    ...
    // B.사용자 상세 조건 조회 (request param: username, email, role) : Mapping requestBody
    // auto mapping
    ...
    // 사용자 상세 조회 페이징 (request param: username, email, role) : Mapping Query String
    // Parameters to ModelAttributes
    ...
    // 사용자 상세 조회 페이징 (request param: username, email, role) : Mapping requestBody
    // auto mapping
    ...
    public ResponseEntity<ApiResponse> updateUser(@PathVariable Long userId,
            @RequestBody UserDto.UserRequest userRequest) {
