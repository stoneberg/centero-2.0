package kr.centero.ghg.common.util;
...
public class EnvUtil implements ApplicationContextAware {
    ...
    public static Resource getResourceFile(String resourcePath) {
        return applicationContext.getResource(String.format(
                !resourcePath.startsWith("classpath:") ? "classpath:%s" : "%s", StringUtils.trimToEmpty(resourcePath)));
    }
